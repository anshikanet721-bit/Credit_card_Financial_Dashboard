...
## Skills Demonstrated
- Data cleaning and transformation using Power Query (M Query)
- DAX measure creation for revenue, interest, and transaction calculations
- Relational data modeling across multiple linked tables
- SQL-based data extraction and analysis
- Interactive dashboard design (KPI cards, slicers, drill-through)
- Customer segmentation and demographic analysis
- Business insight generation and data storytelling
- Dashboard UI/UX and color theming for readability
